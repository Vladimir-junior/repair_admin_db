...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Принят', 'Принят'), ('В работе', 'В работе'), ('Готов', 'Готов')], default='', max_length=70)),
        ...
        migrations.CreateModel(
            name='Story_spare_parts',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('count', models.IntegerField(blank=True)),
                ('description', models.CharField(blank=True, max_length=200)),
                ('timestamp', models.DateField(blank=True)),
                ('purchase_order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='purchase_order', to='users.purchase_order')),
                ('spare_parts', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='spare_parts', to='users.spare_parts')),
